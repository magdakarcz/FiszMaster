...
<div class="sidebar" id="sidebar">
    <div>
        ...
        <ul>
            ...
            <li><a href="../php/all_sets.php" class="uk-active"><i uk-icon="file"></i><span> Wszystkie
                        zestawy</span></a></li>
    ...
    <?php if (isset($_SESSION['user_id'])): ?>
        <ul>
            <li><a class="logout-btn" href="logout.php"><i uk-icon="sign-out"></i><span>Wyloguj się</span></a></li>
        </ul>
    <?php endif; ?>
</div>